            ...
            return (
              ...
              >
                ...
                <td className="pr-2 py-0.5" onClick={(e) => e.stopPropagation()}>
                  <NumericInput
                    value={kf.pos[0]}
                    onChange={(v) => { const pos: [number,number,number] = [...kf.pos]; pos[0] = v; update(kf, { pos }) }}
                    step={0.1}
                    steps={[0.1, 1, 10]}
                    decimals={2}
                    className="w-full"
                ...
                <td className="pr-2 py-0.5" onClick={(e) => e.stopPropagation()}>
                  <NumericInput
                    value={kf.pos[1]}
                    onChange={(v) => { const pos: [number,number,number] = [...kf.pos]; pos[1] = v; update(kf, { pos }) }}
                    step={0.1}
                    steps={[0.1, 1, 10]}
                    decimals={2}
                    className="w-full"
                ...
                <td className="pr-2 py-0.5" onClick={(e) => e.stopPropagation()}>
                  <NumericInput
                    value={kf.pos[2]}
                    onChange={(v) => { const pos: [number,number,number] = [...kf.pos]; pos[2] = v; update(kf, { pos }) }}
                    step={0.1}
                    steps={[0.1, 1, 10]}
                    decimals={2}
                    className="w-full"
